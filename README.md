...
排序(Sorting) 是计算机程序设计中的一种重要操作，它的功能是将一个数据元素（或记录）的任意序列，重新排列成一个关键字有序的序列。简单来说就是将一组无序的数据通过某种算法然后使它们按某种规则有序的排列。
  
排序算法是算法的入门知识，其经典思想可以用于很多算法当中。因为其实现代码较短，应用较常见，所以在面试中经常会问到排序算法及其相关的问题。但万变不离其宗，只要熟悉了思想，灵活运用也不是难事。**一般在面试中最常考的是快速排序和归并排序**，并且经常有面试官要求现场写出这两种排序的代码，对这两种排序的代码一定要信手拈来才行。还有**插入排序、冒泡排序、堆排序、基数排序、桶排序**等，面试官对于这些排序可能会要求比较各自的优劣、各种算法的思想及其使用场景，并分析算法的时间和空间复杂度。通常查找和排序算法的考察是面试的开始，如果这些问题回答不好，估计面试官都没有继续面试下去的兴趣都没了，所以想开个好头就要把常见的排序算法思想及其特点要熟练掌握，有必要时要熟练写出代码。
...
**比较排序**：就是需要通过元素之间比较之后再决定先后顺序
**非比较排序**：就是不需要通过元素之间的比较就可以确定每个元素的位置
![](https://github.com/jia-zh/Sorting-Algorithms/blob/master/images/compare.png)
  
**稳定**：如果a原本在b前面，而a=b，排序之后a仍然在b的前面
**不稳定**：如果a原本在b的前面，而a=b，排序之后a可能会出现在b的后面
![](https://github.com/jia-zh/Sorting-Algorithms/blob/master/images/stability.png)
...
**时间复杂度**: 算法执行所耗费的时间
**空间复杂度**: 算法执行所耗费的内存的大小
![](https://github.com/jia-zh/Sorting-Algorithms/blob/master/images/complexity-table.png)
![](https://github.com/jia-zh/Sorting-Algorithms/blob/master/images/complexity-chart.png)
